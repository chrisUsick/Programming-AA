This paper will give presents an overview of autonomous agents, outlines an environment for programming autonomous agents, and shows an implementation of an autonomous agent, which will run in AA Factory. AA Factory is an interactive programming environment which the autonomous agent will run in.
